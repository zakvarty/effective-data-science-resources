...
:::
:::{.column width="55%"}
![Source: Openscapes blog by J Lowndes and A Horst.](images/horst-wrangle-monsters.jpg)
:::
::::
...
::::{.columns}
:::{.column width="45%"}
![](images/palmer-penguins.png){width="60%"}
:::
:::{.column width="5%"}
:::
:::{.column width="50%"}
...
![](images/view-penguins-screenshot.png)
...
![](images/join-left-right-full.png){width=70%}
