...
<!-- between years find and replace "eds2024" -->
...
I'll follow the inspiration of `{ismev}` and name my minimal package `eds2024`. 

```{r, eval=FALSE, echo=TRUE, filename="Console"}
usethis::create_package(path = "~/Work/teaching/00-effective-data-science/eds2024")
```
...
```{r, eval=FALSE, echo=TRUE, filename="Console"}
✔ Creating '/Users/zakvarty/Work/teaching/00-effective-data-science/eds2024/'
✔ Setting active project to '/Users/zakvarty/Work/teaching/00-effective-data-science/eds2024/'
✔ Creating 'R/'
...
RoxygenNote: 7.2.3
✔ Writing 'NAMESPACE'
✔ Writing 'eds2024.Rproj'
✔ Adding '^eds2024\\.Rproj$' to '.Rbuildignore'
✔ Adding '.Rproj.user' to '.gitignore'
✔ Adding '^\\.Rproj\\.user$' to '.Rbuildignore'
✔ Opening '/Users/zakvarty/Work/teaching/00-effective-data-science/eds2024/' in new RStudio session
✔ Setting active project to '<no active project>'
> usethis::create_package(path = "~/Work/teaching/00-effective-data-science/eds2024/")
✔ Setting active project to '/Users/zakvarty/Work/teaching/00-effective-data-science/eds2024/'Package: eds2024
Title: What the Package Does (One Line, Title Case)
Version: 0.0.0.9000
Authors@R (parsed):
    * First Last <first.last@example.com> [aut, cre] (YOUR-ORCID-ID)
...
```{r, eval=FALSE, echo=TRUE, filename="Console"}
...
── R CMD check results ───────────────────────────────── eds2024 0.0.0.9000 ────
Duration: 5.3s
...
```{r, echo=TRUE, eval=FALSE, filename="DESCRIPTION"}
Package: eds2024
Title: Helper Functions for Effective Data Science 2023-24
Version: 0.0.0.9000
Authors@R: 
    person(
    given = c("Zak","D"),
...
Description: A minimal example R package created during the first lives session 
    of Effective Data Science 2023-24. This countains a simple function to 
